/* $ANTLR 2.7.7 (20110618): "JParser.g" -> "JLexer.cpp"$ */
#include "JLexer.hpp"
...
void JLexer::mPLUS(bool _createToken) {
	int _ttype; antlr::RefToken _token; std::string::size_type _begin = text.length();
	_ttype = PLUS;
	std::string::size_type _saveIndex;
...
void JLexer::mMINUS(bool _createToken) {
	int _ttype; antlr::RefToken _token; std::string::size_type _begin = text.length();
	_ttype = MINUS;
	std::string::size_type _saveIndex;
...
void JLexer::mCHAR(bool _createToken) {
	int _ttype; antlr::RefToken _token; std::string::size_type _begin = text.length();
	_ttype = CHAR;
	std::string::size_type _saveIndex;
...
void JLexer::mDIGIT(bool _createToken) {
	int _ttype; antlr::RefToken _token; std::string::size_type _begin = text.length();
	_ttype = DIGIT;
	std::string::size_type _saveIndex;
...
void JLexer::mOTHER(bool _createToken) {
	int _ttype; antlr::RefToken _token; std::string::size_type _begin = text.length();
	_ttype = OTHER;
	std::string::size_type _saveIndex;
...
const unsigned long JLexer::_tokenSet_0_data_[] = { 0UL, 67053568UL, 0UL, 134217726UL, 0UL, 0UL, 0UL, 0UL };
const antlr::BitSet JLexer::_tokenSet_0(_tokenSet_0_data_,8);
const unsigned long JLexer::_tokenSet_1_data_[] = { 4294958079UL, 4294967295UL, 4294967295UL, 4294967295UL, 0UL, 0UL, 0UL, 0UL };
// 0x0 0x1 0x2 0x3 0x4 0x5 0x6 0x7 0x8 0x9 0xb 0xc 0xe 0xf 0x10 0x11 0x12 
// 0x13 0x14 0x15 0x16 0x17 0x18 0x19 0x1a 0x1b 0x1c 0x1d 0x1e 0x1f   
const antlr::BitSet JLexer::_tokenSet_1(_tokenSet_1_data_,8);
