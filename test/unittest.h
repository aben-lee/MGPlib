// Tencent is pleased to support the open source community by making MGPLIB available.
// 
// Copyright (C) 2018 Xiaobin and Milo Yip. All rights reserved.
//
//
...
#define MGPLIB_ASSERT(x) (!(x) ? throw AssertException(MGPLIB_STRINGIFY(x)) : (void)0u)
